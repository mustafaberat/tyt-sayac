...
const EXAM_DURATION = 135;
const EXAM_MONTH = "Haziran";
const EXAM_DAY = "Cumartesi";
    ...
    return (
      <div className="container">
        ...
        <section className="details-container">
          ...
          <p className="details-detail">Sınav Tarihi: <span>{TARGET_DAY} {EXAM_MONTH} {TARGET_YEAR} {EXAM_DAY}</span></p>
          <p className="details-detail">Sınav Saati: <span>{TARGET_HOUR}.{TARGET_MINUTE}</span></p>
          <p className="details-detail mb">Sınav Süresi: <span>{EXAM_DURATION} dk</span></p>
